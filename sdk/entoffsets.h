...
#define INIT_XOREDNETVAR_SPECIFIC( member_var, offset ) \
		...
		INIT_XOREDNETVAR_SPECIFIC( m_pCoordFrame, g_netvars.get( HASH( "DT_BaseEntity" ), HASH( "m_CollisionGroup" ) ) - 0x30 ); // hope
		...
		INIT_XOREDNETVAR_SPECIFIC(ReadableBones, 0x2698 + 0x4 );
		INIT_XOREDNETVAR_SPECIFIC(WriteableBones, 0x269C + 0x4 );
		INIT_XOREDNETVAR_SPECIFIC(BoneArrayForWrite, 0x2698);
